...
public class EmailService(EmailDTO emailDTO, 
                          ILogger<EmailService> logger) : IEmailService
{
    ...
    private MimeMessage CreateEmailMessage(MessageDTO message)
    {
        try
        {
            ...
            string htmlContent = StyleEmail(message);
    ...
    private static string StyleEmail(MessageDTO message)
    {
        return $@"
            <html>
            <head>
            ...
            <body>
                <div class='container'>
                    ...
                    <p>We're excited to have you on board. Click the button below to confirm your email address and start using our services.</p>
                    <a href='{message.Content}' class='button'>Confirm Your Email</a>
                </div>
            </body>
            </html>";
    }
